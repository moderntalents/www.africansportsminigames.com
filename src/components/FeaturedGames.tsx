      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {featuredGames.map((game) => {
            ...
            return (
              ...
              >
                ...
                <div className="mt-auto px-6 pb-6 pt-2 flex flex-col gap-3">
                  <div className="flex items-center justify-between bg-gray-50 rounded-lg px-4 py-2.5">
                    <span className="text-xs text-gray-500 font-medium">Registration Fee</span>
                    <span className="text-sm font-bold text-gray-900">Sh {game.fee.toLocaleString()}</span>
                  </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-400 text-sm">
            Registration fees are per individual / per team entry. &nbsp;
